...
@Autonomous(name = "BLUENearAuto_1Cycle", group = "2Cycle_Autos")
...
//                .splineToConstantHeading(new Vector2d(51 - yellowDiff,-41), 0)
        ...
        TrajectorySequence CenterPathPicking_Left = drive.trajectorySequenceBuilder(AutoTrajectoryLeft_Purple_Yellow.end())
        ...
        TrajectorySequence CenterPathPlacing_Left = drive.trajectorySequenceBuilder(CenterPathPicking_Left.end())
        ...
        TrajectorySequence WhiteDrop_Left = drive.trajectorySequenceBuilder(CenterPathPlacing_Left.end())
...
//        TrajectorySequence CenterPathPicking2_Left = drive.trajectorySequenceBuilder(WhiteDrop_Right.end())
//                .build();
//        TrajectorySequence CenterPathPlacing2_Left = drive.trajectorySequenceBuilder(CenterPathPicking2_Right.end())
//                .build();
//        TrajectorySequence WhiteDrop2_Left = drive.trajectorySequenceBuilder(CenterPathPlacing2_Right.end())
//                .build();
...
//                .build();
        ...
        TrajectorySequence ParkingOut = drive.trajectorySequenceBuilder(WhiteDrop_Right.end())
        ...
        while (opModeIsActive()) {
            ...
            switch (currentLeftState){
                ...
                case AutoTrajectoryLeft_Purple_Yellow:
                    if(!drive.isBusy()){
                        currentLeftState = AutoTrajectoryLeft.CenterPathPicking_Left;
                        drive.followTrajectorySequenceAsync(CenterPathPicking_Left);
                    }
                    break;
                case CenterPathPicking_Left:
                    if(!drive.isBusy()){
                        currentLeftState = AutoTrajectoryLeft.CenterPathPlacing_Left;
